...
class HomeworkCategory(Base):
    """作业分类表"""
    __tablename__ = "homework_categories"
    ...
    # 关系
    homeworks = relationship("Homework", back_populates="category")
...
class Homework(Base):
    ...
    # 分类
    category_id = Column(Integer, ForeignKey("homework_categories.id"), nullable=True)
    ...
    # 关系
    category = relationship("HomeworkCategory", back_populates="homeworks")
